...
Core.Functions.CreateCallback('core-weapons:server:GetConfig', function(_, cb)
...
Core.Functions.CreateCallback('core-weapons:server:RepairWeapon', function(src, cb, RepairPoint, data)
    ...
    if not exports['qb-inventory']:RemoveItem(src, data.name, 1, data.slot, 'core-weapons:server:RepairWeapon') then
        Player.Functions.AddMoney('cash', Config.WeaponRepairCosts[WeaponClass], 'core-weapons:server:RepairWeapon')
        return
    end
    ...
    TriggerClientEvent('core-weapons:client:SyncRepairShops', -1, Config.WeaponRepairPoints[RepairPoint], RepairPoint)
...
RegisterNetEvent('core-weapons:server:TakeBackWeapon', function(k)
    ...
    TriggerClientEvent('core-weapons:client:SyncRepairShops', -1, Config.WeaponRepairPoints[k], k)
end)
